class AppText {
  ...
  static const String kAppName = 'Grocery App';
  ...
  static const String kCollection = 'Fresh Arrivals';
  ...
  static const String kWelcomeHeader =
     "The Grocery App That \nMakes Shopping Easier & Smarter";
  static const String kWelcomeMessage =
      "Welcome to Grocery app! Let's get started ";
      ...
      // "Welcome to the ultimate grocery destination!";
      "welcome";
}
