...
import 'package:grocery_app/src/cart/models/cart_model.dart';
import 'package:grocery_app/src/cart/widgets/cart_counter.dart';
import 'package:grocery_app/src/cart/widgets/update_button.dart';
                          ...
                          children: [
                            ...
                            cartNotifier.selectedCart != null &&
                                ...
                                : Padding(
                                    ...
                                    child: ReusableText(
                                        text:
                                         "Rs ${(cart.quantity * cart.product.price).toStringAsFixed(2)}",
